    ...
    return(
        ...
        (<div style={{ margin: '0 auto', marginTop: '5px', width: '300px', textAlign: 'center' }}>
            <Button onClick={async()=>{
                //
                await axios.post(`http://ec2-13-232-74-5.ap-south-1.compute.amazonaws.com:5000/addtofirstlist?phone=${phone}`).then((response)=>{
                ...
                <div style={{ backgroundColor: '#ffffff', height: '400px', margin: '0 auto', width: '300px', textAlign: 'center' }}>
                    ...
                    (<div style={{ margin: '0 auto', marginTop: '5px', width: '300px', textAlign: 'center' }}>
                        <Button onClick={async()=>{
                            //
                            //setModal(true)
                            await axios.post(`http://ec2-13-232-74-5.ap-south-1.compute.amazonaws.com:5000/verify?phone=${phone}&otp=${otp}`).then((response)=>{
                               // const a = response.data;
